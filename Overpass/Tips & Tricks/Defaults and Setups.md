...
#### [Fountain Control](https://youtu.be/2Pg5NtvdaPI?si=lOJztIeVyY0OcX1H)
- In this example I wanted to mainly focus on the taking fountain portion.
- We throw the [[Overpass Nades/T Main Smoke|T Main Smoke]] and [[Overpass Nades/T Ramp Molotov|T-ramp molly]]
...
- After they get the pick they full rotate down to B 

#### [4B Stack](https://youtu.be/p9u7_SlvrLU?si=x7Ytg_8PR1y0ncSt)
- Here they start over 4 towards B.
...
- Ari and I would be in Conn (Yuurih and Fallen)
	- They Flash and molly. A 2nd flash is thrown to actually peak top conn
	- After clearing conn and front bath fallen full rotates over to B to help take water 
- Andre (Kscerato)
	- Watches Monster mainly. Comes out monster as part of the B attack
Everybody by 30 seconds can be seen grouping together and taking the site that they have more control over. 


#### [2-2-1 into split A](https://youtu.be/fNLLE5IlInY?si=NOwAnP8nckAA1c5)
- A lot of similar stuff as the previous entry. 
- Over on A, molodoy and yekindar can be seen waiting out the early foutain aggresion util. They are patient and once the smokes fade/the conn player is up then they begin to take space over towards long 
...
The conn players group up for the banana side of the attack
The long players throw the util while the banana players are just taking duels
